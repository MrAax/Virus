...
if %UserName%==Mansu (
if %password%==1234 goto :Sucess
)
goto :2
:LOCKOUT
echo ACCOUNT LOGOUT AFTER IN 10 secend.
::timeout /t 3600
...
echo. ----------------------------------------------------------------------------------------------------------------------
::if  "%UserName%" exist ( goto command )
::if not exist ( call login.bat )
ping 192.168.0.1. -n 1 -w 4000 >nul
ping localhost -n 3 >nul
:command
cls 
...
echo. **********************************************************************************************************************
echo  *************** If find all Command Type 'H'******************************************
echo  **********************************************************************************************************************
echo.
set /p cho=Enter your command: 
if %cho%==h goto help
if %cho%==H goto help
if %cho%==logout goto Starter1
...
::if exist "%UserName%" ( goto start ) ::if not exist ( call login.bat )
