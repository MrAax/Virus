...
if "%user%"=="www.mlucky.com" (if "%password%"=="2000" goto correct )
...
::timeout /t 5 /nobreak 
::ping 192.168.0.1. -n 1 -w 4000 >nul goto :login
goto Start
...
echo.
if %counter% lss 3 echo %counter% attempts left
pause
goto :Start
:: ------------------------------------------------------------------------
:correct
...
ping 192.168.1.1. -n 1 -w 4000 >nul
ping localhost -n 3 >nul
:command
